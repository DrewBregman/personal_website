...
class EditBlogpostWidget extends StatefulWidget {
  const EditBlogpostWidget({
    Key? key,
  ...
  @override
  _EditBlogpostWidgetState createState() => _EditBlogpostWidgetState();
}

class _EditBlogpostWidgetState extends State<EditBlogpostWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BlogPostRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final editBlogpostBlogPostRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  final blogPostUpdateData =
                                      createBlogPostRecordData(
                                    content: editBlogpostBlogPostRecord.content,
                            ...
                            Expanded(
                              child: TextFormField(
                                controller: textController1 ??=
                                  ...
                                  text: editBlogpostBlogPostRecord.title,
                                ),
                                autofocus: true,
                                obscureText: false,
